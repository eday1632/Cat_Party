...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawable(Context context, View animExcutor) {
        ...
        int cpTurquoise = context.getResources().getColor(R.color.cpblue);
        int cpFuchsia = context.getResources().getColor(R.color.cpfuchsia);
        int cpGreen = context.getResources().getColor(R.color.cpgreen);
        int[] cpColors = new int[] {cpFuchsia, cpTurquoise, cpGreen};
        mRing = new Ring(mCallback);
        mRing.setColors(cpColors);
